    ...
    render() {
        ...
        return (
            <div className={css(styles.wrapper, !this.props.shown && styles.hidden)}>
                ...
                <LinkBubble alt='mediumIcon' iconImg={mediumIcon} link={mediumLink} iconWidth='65%' onMouseOver={this.setMessageOnMouseOver(mediumMsg)}  />
                ...
                <LinkBubble alt='chatIcon' iconImg={chatIcon} iconWidth='55%' onMouseOver={isInputMode? null : this.setMessageOnMouseOver(chatMsg)} onClick={this.toChatMode} />
            </div>
        );
    }
