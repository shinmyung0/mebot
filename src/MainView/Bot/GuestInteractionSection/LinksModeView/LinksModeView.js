...
class LinksModeView extends React.Component {
  ...
  render() {
    ...
    const linkedInMsg =
      "That's my Linked In. Check it out if you want to see my resume.";
    const githubMsg =
      "That's my Github. Check it out if you want to check out some of my projects.";
    const mediumMsg =
      "That's my Medium blog where I write about things I'm interested in. Always looking for more readers!";
    ...
    return (
      <div className={css(styles.wrapper, !this.props.shown && styles.hidden)}>
        <LinkBubble
          ...
          link={linkedInLink}
          iconWidth="65%"
          onMouseOver={this.setMessageOnMouseOver(linkedInMsg)}
        />
        <LinkBubble
          alt="mediumIcon"
          iconImg={mediumIcon}
          link={mediumLink}
          iconWidth="63%"
          onMouseOver={this.setMessageOnMouseOver(mediumMsg)}
        />
        <LinkBubble
          alt="githubIcon"
          iconImg={githubIcon}
          link={githubLink}
          iconWidth="70%"
          onMouseOver={this.setMessageOnMouseOver(githubMsg)}
        />
        <LinkBubble
          alt="chatIcon"
          iconImg={speechBubbleIcon}
          iconWidth="65%"
          onMouseOver={isInputMode ? null : this.setMessageOnMouseOver(chatMsg)}
          onClick={this.toChatMode}
        />
      </div>
    );
  }
